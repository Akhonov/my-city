...
class PlacedImprovement(Base):
    __tablename__ = "placed_improvements"
    ...
    source: Mapped[str] = mapped_column(String(30), nullable=False, default="user", index=True)
    user_identifier: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
